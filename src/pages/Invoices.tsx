  ...
  const fetchInvoices = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        'https://script.google.com/macros/s/AKfycbzxJUc4GBGc88LF-enlrIyg6vd2P8IMBnDDd4IOhZfTIz33V8BGHKmDJ3vFLnQvRUyDog/exec?action=Invoicetstenew'
      );
...
console.log("Deleting product:", invoiceToDelete);
  try {
    const res = await fetch(`https://script.google.com/macros/s/AKfycbzxJUc4GBGc88LF-enlrIyg6vd2P8IMBnDDd4IOhZfTIz33V8BGHKmDJ3vFLnQvRUyDog/exec?action=deleteinvoice&InvoiceNumber=${invoiceToDelete}`, {
      method: "GET",
    });
